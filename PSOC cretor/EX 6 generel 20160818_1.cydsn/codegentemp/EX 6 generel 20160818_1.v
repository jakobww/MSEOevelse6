// ======================================================================
// EX 6 generel 20160818_1.v generated from TopDesign.cysch
// 01/09/2017 at 08:55
...
// Filter_v2_20(ChannelEnableA=true, ChannelEnableB=false, ChannelSettingsA=<enabled=true>\r\n<userEntryEnabled=false>\r\n<sampleRate=2.006>\r\n<filterGain_dB=0>\r\n<filterGain_Linear=1>\r\n<gainScale=LINEAR>\r\n<width=WIDTH_16>\r\n<signal=DMA>\r\n<stage_count=1>\r\n<bus_clock=0.2608>\r\n<stage0=\r\n    <design_type=BIQUAD>\r\n    <pass_type=LOW_PASS>\r\n    <shape=BESSEL>\r\n    <order=24>\r\n    <ripple=0.1>\r\n    <primary_freq=0.1>\r\n    <bandwidth=0.01>\r\n    <UserCoefficient=>\r\n    <userOrder=1>\r\n>\r\n<stage1=\r\n    <design_type=BIQUAD>\r\n    <pass_type=LOW_PASS>\r\n    <shape=BESSEL>\r\n    <order=24>\r\n    <ripple=0.1>\r\n    <primary_freq=1>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userOrder=1>\r\n>\r\n<stage2=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage3=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage4=\r\n    <design_type=FIR>\r\n    <pass_type=BAND_STOP>\r\n    <window_type=BLACKMAN>\r\n    <tap_count=16>\r\n    <primary_freq=1>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage5=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage6=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage7=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n, ChannelSettingsB="", ChannelTypeA=11, ChannelTypeB=0, CoefficientEntryEnableA=false, CoefficientEntryEnableB=false, DisplaySettingsA=50307, DisplaySettingsB=50307, DmaEnableA=true, DmaEnableB=false, IrqEnableA=false, IrqEnableB=false, MinBusClockVal=0.2608, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Filter_v2_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Filter_1, CY_INSTANCE_SHORT_NAME=Filter_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=Filter_1, )
module Filter_v2_20_0 (
    DMA_Req_A,
    DMA_Req_B,
    Interrupt);
    output      DMA_Req_A;
...
module top ;
	...
	wire [0:0] tmpOE__test_01_net;
	wire [0:0] tmpFB_0__test_01_net;
	wire [0:0] tmpIO_0__test_01_net;
	wire [0:0] tmpINTERRUPT_0__test_01_net;
	electrical [0:0] tmpSIOVREF__test_01_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		test_01
		 (.oe(tmpOE__test_01_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__test_01_net[0:0]}),
		  .io({tmpIO_0__test_01_net[0:0]}),
		  .siovref(tmpSIOVREF__test_01_net),
		  .interrupt({tmpINTERRUPT_0__test_01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__test_01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 V_noise (
        .connect({
            Net_175,
            Net_177
        })
    );
    defparam V_noise.comp_name = "VSource_v1_0";
    defparam V_noise.port_names = "N, P";
    defparam V_noise.width = 2;

    cy_annotation_universal_v1_0 Ro (
        .connect({
            Net_20,
            Net_189
        })
    );
    defparam Ro.comp_name = "Resistor_v1_0";
    defparam Ro.port_names = "T1, T2";
    defparam Ro.width = 2;

    cy_annotation_universal_v1_0 V_response (
        .connect({
            Net_176,
            Net_175
        })
    );
    defparam V_response.comp_name = "VSource_v1_0";
    defparam V_response.port_names = "N, P";
    defparam V_response.width = 2;
	...
	wire [0:0] tmpOE__Signal_in_net;
	wire [0:0] tmpFB_0__Signal_in_net;
	wire [0:0] tmpIO_0__Signal_in_net;
	wire [0:0] tmpINTERRUPT_0__Signal_in_net;
	electrical [0:0] tmpSIOVREF__Signal_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		Signal_in
		 (.oe(tmpOE__Signal_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Signal_in_net[0:0]}),
		  .analog({Net_70}),
		  .io({tmpIO_0__Signal_in_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_in_net),
		  .interrupt({tmpINTERRUPT_0__Signal_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_123 = Net_121 & Net_57;

    Filter_v2_20_0 Filter_1 (
        .DMA_Req_A(Net_82),
        .DMA_Req_B(Net_179),
        .Interrupt(Net_180));
    ...
    ADC_DelSig_v3_0_2 ADC_DelSig_1 (
        .vplus(Net_70),
        .vminus(Net_75),
        .soc(1'b1),
        .eoc(Net_56),
    ...
    cy_annotation_universal_v1_0 V_offset (
        .connect({
            Net_177,
            Net_20
        })
    );
    defparam V_offset.comp_name = "VSource_v1_0";
    defparam V_offset.port_names = "N, P";
    defparam V_offset.width = 2;
