    ...
    CY_ISR(USBUART_1_ARB_ISR)
    {
        ...
        ******************************************************************************/
        void USBUART_1_EP1_DMA_DONE_ISR(void)
        {
            ...
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP1])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP1];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP1_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP1] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP1] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            if (0u != (USBUART_1_EP[USBUART_1_EP1].addr & USBUART_1_DIR_IN))
            {
                ...
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP1_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP2_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP2])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP2];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP2_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP2] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP2] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP2_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP3_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP3])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP3];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP3_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP3] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP3] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP3_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP4_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP4])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP4];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP4_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP4] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP4] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP4_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP5_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP5])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP5];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP5_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP5] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP5] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP5_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP6_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP6])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP6];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP6_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP6] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP6] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP6_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP7_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP7])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP7];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP7_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP7] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP7] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP7_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
        ...
        ******************************************************************************/
        void USBUART_1_EP8_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBUART_1_DmaEpBurstCnt[USBUART_1_EP8])
            {
                /* Decrement burst counter. */
                --USBUART_1_DmaEpBurstCnt[USBUART_1_EP8];
            }
            else
            {
                /* Adjust length of last burst. */
                USBUART_1_CyDmaSetNumDataElements(USBUART_1_EP8_DMA_CH,
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP8] >> USBUART_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBUART_1_DmaEpLastBurstEl[USBUART_1_EP8] &  USBUART_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBUART_1_CyDmaGetSrcAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetSrcAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBUART_1_CyDmaGetDstAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR0);
                nextAddr += (2u * USBUART_1_DMA_BYTES_PER_BURST);
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBUART_1_DMA_BYTES_PER_BURST;
                USBUART_1_CyDmaSetDstAddress(USBUART_1_EP8_DMA_CH, USBUART_1_DMA_DESCR1, (void *) nextAddr);
            }
